...
将对应链接导入你的广告拦截工具即可。支持以下三种方式获取规则：

| 规则类型 | jsDelivr CDN（中国大陆推荐） | GitHub Raw（全球） | gh.llkk.cc 加速（备用） |
|---------|:---:|:---:|:---:|
| 🟦 **AdBlock**（浏览器） | `https://cdn.jsdelivr.net/gh/Chaniug/FilterFusion@main/dist/adblock-main.txt` | `https://raw.githubusercontent.com/Chaniug/FilterFusion/main/dist/adblock-main.txt` | `https://gh.llkk.cc/https://raw.githubusercontent.com/Chaniug/FilterFusion/main/dist/adblock-main.txt` |
| 🟪 **DNS**（网络级） | `https://cdn.jsdelivr.net/gh/Chaniug/FilterFusion@main/dist/dns-blocklist.txt` | `https://raw.githubusercontent.com/Chaniug/FilterFusion/main/dist/dns-blocklist.txt` | `https://gh.llkk.cc/https://raw.githubusercontent.com/Chaniug/FilterFusion/main/dist/dns-blocklist.txt` |
